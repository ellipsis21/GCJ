<?php
	...
	*/
	...
	//$result = mysqli_query($con,"INSERT VALUES Questions (Type, Question, GroupId, UserId) VALUES ('MC', 'What is your favorite Color?', 27, 1)");
	...
	$result = mysqli_query($con,"INSERT INTO Responses (QuestionId, Response, Phone) VALUES (1, '1', '1111')");
